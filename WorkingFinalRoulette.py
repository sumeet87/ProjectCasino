...
def main():
    ...
    while total_chips > 0:  # game starts and carries on as far as player has chips, though player can choose to quit at end of each round.
        ...
        dozens, total_chips = dozens_bets(total_chips)  # calls funtion, which returns bets on combi of dozens and amount of chips on each dozen in a list
        halves, total_chips = halves_bets(total_chips)  # calls funtion, which returns bets on combi of halves and amount of chips on each half in a list
